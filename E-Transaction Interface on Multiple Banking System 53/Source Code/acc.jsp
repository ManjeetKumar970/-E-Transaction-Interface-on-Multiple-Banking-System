...
PreparedStatement st1=con.prepareStatement("select * from customer where cid=? and bname=? and accno=? and atype=?");
	...
	st1.setString(2,sbname);
	   st1.setString(3,saccno);
...
PreparedStatement st2=con.prepareStatement("select * from customer where cid=? and bname=? and accno=? and atype=?");
	   st2.setString(1,cid);
		st2.setString(2,dbname);
	   st2.setString(3,daccno);
	   st2.setString(4,dtype);
...
{
	%>
 <center><BR><font color="red" style="background-color: rgb(255, 255, 255)"><h2> Transaction is  Accepted</h2></font></center>
 <BR><BR><center>
 <input type="button" value="     back     " onclick="window.location='bmain.jsp'"> </center> 
<%
